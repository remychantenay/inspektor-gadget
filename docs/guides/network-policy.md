...
```bash
$ kubectl gadget advisor network-policy monitor --namespaces demo --output ./networktrace.log
```
...
```bash
$ kubectl gadget advisor network-policy report --input ./networktrace.log > network-policy.yaml
```
